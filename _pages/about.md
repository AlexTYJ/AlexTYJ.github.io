...
## <span class="i18n-zh">精选论文</span><span class="i18n-en">Selected publications</span>

{% include widgets/featured-publications.html %}

## <span class="i18n-zh">教育经历</span><span class="i18n-en">Education</span>

<div class="i18n-zh" markdown="1">

- <i class="fa-solid fa-microscope fa-fw" aria-hidden="true"></i> **2026.9 – 至今** · 上海创智学院 & 中国科学院自动化研究所，模式识别与智能系统
- <i class="fa-solid fa-building-columns fa-fw" aria-hidden="true"></i> **2025.1 – 2025.5** · 加州大学伯克利分校，访问学生
- <i class="fa-solid fa-building-columns fa-fw" aria-hidden="true"></i> **2022.9 – 2026.6** · 中国科学院大学，人工智能学院
- <i class="fa-solid fa-school fa-fw" aria-hidden="true"></i> **2019.9 – 2022.6** · 江苏省锡山高级中学
{: .timeline-list}
...
- <i class="fa-solid fa-microscope fa-fw" aria-hidden="true"></i> **Sep 2026 – present** · Shanghai Innovation Institute & Institute of Automation, CAS — Pattern Recognition and Intelligent Systems
- <i class="fa-solid fa-building-columns fa-fw" aria-hidden="true"></i> **Jan 2025 – May 2025** · University of California, Berkeley — visiting student
- <i class="fa-solid fa-building-columns fa-fw" aria-hidden="true"></i> **Sep 2022 – Jun 2026** · University of Chinese Academy of Sciences — School of Artificial Intelligence
- <i class="fa-solid fa-school fa-fw" aria-hidden="true"></i> **Sep 2019 – Jun 2022** · Xishan Senior High School of Jiangsu Province
{: .timeline-list}

</div>

## <span class="i18n-zh">工作经历</span><span class="i18n-en">Experience</span>

<div class="i18n-zh" markdown="1">

- <i class="fa-solid fa-building fa-fw" aria-hidden="true"></i> **2025.10 – 至今** · 微软亚洲研究院，通用人工智能研究组
- <i class="fa-solid fa-building fa-fw" aria-hidden="true"></i> **2025.6 – 2025.9** · 字节跳动，TikTok
{: .timeline-list}
...
- <i class="fa-solid fa-building fa-fw" aria-hidden="true"></i> **Oct 2025 – present** · Microsoft Research Asia — General Artificial Intelligence group
- <i class="fa-solid fa-building fa-fw" aria-hidden="true"></i> **Jun 2025 – Sep 2025** · ByteDance — TikTok
{: .timeline-list}

</div>

## <span class="i18n-zh">奖项荣誉</span><span class="i18n-en">Awards</span>

<div class="i18n-zh" markdown="1">

- <i class="fa-solid fa-medal fa-fw" aria-hidden="true"></i> 中国科学院大学 二等学业奖学金
- <i class="fa-solid fa-medal fa-fw" aria-hidden="true"></i> 中国科学院大学 三等学业奖学金
{: .timeline-list}
...
- <i class="fa-solid fa-medal fa-fw" aria-hidden="true"></i> Second-Class Academic Scholarship, University of Chinese Academy of Sciences
- <i class="fa-solid fa-medal fa-fw" aria-hidden="true"></i> Third-Class Academic Scholarship, University of Chinese Academy of Sciences
{: .timeline-list}
